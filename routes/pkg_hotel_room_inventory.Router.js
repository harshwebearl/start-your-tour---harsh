...
const room_Controller = require("../controllers/pkg_hotel_room_inventory.Controller");
...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, "public/images/pkg_hotel_room"); // Set the destination folder for uploaded files
  },
  filename: function (req, file, cb) {
