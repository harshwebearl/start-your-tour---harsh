...
// const fn = "dastinationcategory"; // Note: The folder name is 'dastinationcategory' (with 'a' not 'e')
...
//         // Price per person & days (from first valid package)
//         let price_per_person = null;
//         let days = "";
//         if (Displaymostlovaeddestionation[i].Package && Displaymostlovaeddestionation[i].Package.length > 0) {
//           const pkg = Displaymostlovaeddestionation[i].Package[0];
//           if (pkg.price_and_date && pkg.price_and_date.length > 0) {
//             price_per_person = pkg.price_and_date[0].price_per_person;
//           }
//           days = pkg.total_days || "";
//         }
//         Displaymostlovaeddestionation[i].price_per_person = price_per_person;
//         Displaymostlovaeddestionation[i].days = days;

//         // avg_rating & total_reviews (from reviews)
//         let total_reviews = Displaymostlovaeddestionation[i].Reviews.length;
//         let avg_rating = 0;
//         if (total_reviews > 0) {
//           let sum = 0;
//           Displaymostlovaeddestionation[i].Reviews.forEach(r => {
//             sum += parseFloat(r.star || 0);
//           });
//           avg_rating = sum / total_reviews;
//         }
//         Displaymostlovaeddestionation[i].avg_rating = Number(avg_rating.toFixed(1));
//         Displaymostlovaeddestionation[i].total_reviews = total_reviews;

//         // Remove raw arrays if you don't want them in response
//         delete Displaymostlovaeddestionation[i].Package;
//         delete Displaymostlovaeddestionation[i].Reviews;
//       }
...
//       // Return each data type as a separate array in the response
//       return this.sendJSONResponse(
//         res,
//         "Data retrieved successfully",
//         {
//           visa_on_Arrival: visa_on_Arrival.length,
//           DestinationData: DestinationData.length,
//           most_lovaed_destionation: Displaymostlovaeddestionation.length,
//           Saftyinformation: adddata.length,
//           hotel_data: hotel_syt_display.length,
